...
import {
  ...
  StockQuotesConnectorProps,
} from 'Layers/Adapter/StockQuotesConnector/StockQuotesConnector';

let digest: number;

export const StockQuotesUpdater = <OwnProps>(): ComponentEnhancer<OwnProps, OwnProps> => compose(
  StockQuotesConnector,
  lifecycle<StockQuotesConnectorProps, Record<string, never>>({
